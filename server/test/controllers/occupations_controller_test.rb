...
class OccupationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create occupation" do
    assert_difference('Occupation.count') do
      post occupations_url, params: { occupation: { activity: @occupation.activity, description: @occupation.description } }, as: :json
    end
  ...
  test "should update occupation" do
    patch occupation_url(@occupation), params: { occupation: { activity: @occupation.activity, description: @occupation.description } }, as: :json
    assert_response 200
  end
